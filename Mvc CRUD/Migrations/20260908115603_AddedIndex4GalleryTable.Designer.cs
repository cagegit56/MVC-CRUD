...
namespace Mvc_CRUD.Migrations
{
    ...
    [Migration("20260908115603_AddedIndex4GalleryTable")]
    partial class AddedIndex4GalleryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mvc_CRUD.Models.FriendRequest", b =>
                {
                    ...
                    b.Property<string>("ToUser_LastName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ToUser_ProfilePicUrl")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("UserId", "ToUserId", "Status", "isDeleted");
            ...
            modelBuilder.Entity("Mvc_CRUD.Models.Friends", b =>
                {
                    ...
                    b.HasIndex("FriendName", "UserName");

                    b.HasIndex("UserId", "FriendId");

                    b.HasIndex("UserName", "FriendName");

                    b.ToTable("Friends");
                });

            modelBuilder.Entity("Mvc_CRUD.Models.GalleryImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mvc_CRUD.Models.ReplyOfReply", b =>
                {
                    b.HasOne("Mvc_CRUD.Models.CommentsReply", "CommentReplies")
                        .WithMany("Replies")
